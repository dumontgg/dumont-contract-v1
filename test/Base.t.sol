...
abstract contract BaseTest is Test, Constants {
    ...
    function deployContracts() internal {
        ...
        gameFactory = new GameFactory(usdt, vault, address(revealer), ONE_HOUR * 12, ONE_HOUR * 6, 1e18);
        rewardManager = new RewardManager(address(vault), mont, IQuoter(address(0x00)), usdt, 3000);
